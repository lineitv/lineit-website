...
import Web1 from "../../../public/images/markting.png";
...
const Web = () => {
  const title = 'خدمة ديجيتال ماركتينج';
  const url = '/services/digital-marketing-company';
  const description = 'شركة لاين اي تي أفضل شركة ديجيتال ماركيتنج في مصر - تصفح خدمة ديجيتال ماركيتنج في الشركة';
  const keywords = [ "أفضل شركة ديجيتال ماركيتنج في مصر","شركة ديجيتال ماركيتنج","أفضل سعر لشركة ديجيتال ماركيتنج","شركة اعلانات فيسبوك","شركة اعلانات انستجرام","شركة تصميم هويات مواقع كاملة", "شركة لاين اي تي"]
    ...
    return (
        ...
        <ShemaMeta
            ...
            description={description}
      />
            <Navbar en="/en/services/digital-marketing-company"/>
...
بولد براند ، هي خدمة تسويق رقمي في مصر ، تقدم حلول التسويق الرقمي والتسويق عبر البريد الإلكتروني للمستهلكين الموجودين على مستوى العالم. نحن نقوم بمهمة دعم شركتك عبر الإنترنت. يمكن الوصول إلى عدد من محركات البحث عبر الإنترنت.
      ...
      <CldImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/marketing_gq9jj3.webp" width={1000} height={1000} alt="أفضل شركة ديجيتال ماركينج في مصر والوطن العربي - لاين اي تي" objectFit="cover" />
      </motion.div>
    </motion.div>
