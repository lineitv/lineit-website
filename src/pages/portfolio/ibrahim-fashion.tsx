  ...
  return (
    <>
        ...
        <ShemaMeta
            ...
            description={description}
      />
            <Navbar en="/en/portfolio/ibrahim-fashion"/>
    ...
    animate="visible" className="flex lg:flex-row flex-col justify-around items-center lg:mt-14 md:mt-24 sm:mt-28 mt-24 min-w-7xl md:h-[70vh]">
      <div className="flex flex-col items-center justify-center md:ml-20 md:w-[-webkit-fill-available] mx-10 mt-10 md:mt-0">
        ...
        <p dir='rtl' className="md:text-xl text-xl font-semibold text-[rgba(38,39,41,.7)] mt-5 lg:block block">
          {" "}
          إنه موقع ويب سريع الاستجابة للفاشون لبدلات الرجال تم تصميمه بغرض عرض أزياء مختلفة لابراهيم لتسهيل عملية التصفح. يعمل الموقع علي جميع الشاشات ويقدم العديد من الخدمات مثل: العروض والخصومات والمقالات على مختلف المنتجات وكتابة الكلمات الرئيسية للمستخدمين الذين يبحثون عن اصغر موديل في مصر او موديل بشكل عام وتطوير العلامة التجارية عبر الإنترنت مع أفضل تحسين محركات البحث.
        </p>
        <div className="mt-10 flex justify-center items-center gap-5">
        <a target='_blank' href='https://ibrahim.elias-designer.com' className="text-white bg-[#E84E36] font-semibold rounded-full px-5 md:py-4 py-2 hover:bg-black hover:shadow-lg">
            مشاهدة الموقع
          </a>
      ...
      <CldImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/work-ibrahim_zhhvse.webp" width={2000} height={2000} alt="موقع ابراهيم اصغر موديل في مصر من تصميم شركة لاين اي تي - افضل شركة تصميم وتطوير مواقع وتطبيقات في مصر" objectFit="cover" />
      <CldOgImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/work-ibrahim_zhhvse.webp" width={2000} height={2000} alt="موقع ابراهيم اصغر موديل في مصر من تصميم شركة لاين اي تي - افضل شركة تصميم وتطوير مواقع وتطبيقات في مصر" objectFit="cover" />
      </motion.div>
    </motion.div>
