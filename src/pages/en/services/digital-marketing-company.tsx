...
const Web = () => {
  const title = 'Digital Marketing service';
  const url = '/en/services/digital-marketing-company';
  const description = 'Line IT Best Digital Marketing Company In Egypt - Read More In Line IT Digital Marketing Service';
  const keywords = [ "Best Digital Marketing Company In Egypt"," Digital Marketing Company"," Best Brice Digital Marketing Company","Marketing Company","Ads Company","Facebook Ads Company","instagram Ads Company","Tiktok Ads Company", "Line IT Company"]
    ...
    return (
      ...
      />
            ...
            <Navbar ar="/services/digital-marketing-company" />
    ...
    whileInView="visible" className="flex lg:flex-row flex-col justify-around items-center lg:mt-20 md:mt-24 sm:mt-28 mt-24 min-w-7xl md:h-[90vh]">
      ...
      <CldImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/markting_mgqbwt.webp" width={2000} height={2000} alt="The best Digital Marketing and facebook ads company in Egypt and the Arab world - Line IT" objectFit="cover" />
        <CldOgImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/markting_mgqbwt.webp" width={2000} height={2000} alt="The best Digital Marketing and facebook ads company in Egypt and the Arab world - Line IT" objectFit="cover" />
      </motion.div>
      {/* textual area */}
    ...
    whileInView="visible" className="flex lg:flex-row flex-col justify-around items-center lg:mt-4 md:mt-4 sm:mt-4 mt-4 min-w-7xl md:h-[70vh]">
      ...
      <CldImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/marketing_gq9jj3.webp" width={1000} height={1000} alt="The best marketing and facebook ads company in Egypt and the Arab world - Line IT" objectFit="cover" />
      </motion.div>
    </motion.div>
