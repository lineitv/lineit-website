  ...
  return (
    <>
      ...
      />
            ...
            <Navbar ar="/portfolio/ibrahim-fashion" />
    ...
    whileInView="visible" className="flex lg:flex-row flex-col justify-around items-center lg:mt-20 md:mt-24 sm:mt-28 mt-14 min-w-7xl md:h-[auto]">
      ...
      <CldImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/work-ibrahim_zhhvse.webp" width={2000} height={2000} alt="ibrahim fashion website made by Line IT Company - Best Web Development Company In Egypt and the Arab world" objectFit="cover" />
        <CldOgImage src="https://res.cloudinary.com/dzxbbqq4l/image/upload/v1687299784/work-ibrahim_zhhvse.webp" width={2000} height={2000} alt="ibrahim fashion website made by Line IT Company - Best Web Development Company In Egypt and the Arab world" objectFit="cover" />
      </motion.div>
      {/* textual area */}
      <div className="flex flex-col items-center justify-start md:ml-20 md:w-[-webkit-fill-available] mx-10 mt-10 md:mt-0">
        ...
        <p dir="rtl" className="md:text-xl text-xl text-center font-semibold text-[rgba(38,39,41,.7)] mt-5 lg:block block">
          {" "}
          It is a responsive website for ibrahim fashion designer with the purpose of showcasing different fashions of Ibrahim for easy browsing. The site works on all screens and offers many services such as: offers, discounts, articles on various products, writing keywords for users who are looking for the smallest model in Egypt or a model in general, and developing the brand online with the best search engine optimization.
        </p>
        <div className="mt-10 flex justify-center items-center gap-5">
        <a target='_blank' href='https://ibrahim.elias-designer.com/en' className="text-white bg-[#E84E36] font-semibold rounded-full px-5 md:py-4 py-2 hover:bg-black hover:shadow-lg">
            Vist Website ibrahim
          </a>
